...
public class RPBridgeStateChart extends ARPBridge {
    ...
    protected boolean isUpdateActivityPin(String activityName, IRPPin rpPin, DoxygenType type) {
        ...
        // debug(rpPin.getName() + " Type is change "+ rpTypeName + "->" +
        // param.getType());
        // return true;
        // }
    ...
    protected void applyPin(IRPFlowchart flowchart, IRPPin rpPin, DoxygenTypeParam param, String currentVersion,
            int index) {
    ...
    protected void applyReturnPin(IRPFlowchart flowchart, IRPPin rpPin, DoxygenType param, String currentVersion,
            int index) {
