...
public class RPExtensionUtilities extends RPUserPlugin {
	 ...
	 * 
	 * @see
	 * com.telelogic.rhapsody.core.RPUserPlugin#RhpPluginInit(com.telelogic.rhapsody
	 * .core.IRPApplication)
	 */
	 ...
	 * 
	 * @see
	 * com.telelogic.rhapsody.core.RPUserPlugin#OnMenuItemSelect(java.lang.String)
	 */
	...
	public void OnTrigger(String trigger) {
		...
		// JOptionPane.showMessageDialog(null, "Hello world from SimplePlugin.OnTrigger
		// " + trigger);
